...
[![CalVer v202103.1028][version_img]][version_ref]
...
markdown-katex version:  v202103.1028 (using binary: /usr/local/bin/npx --no-install katex)
0.13.0
```
...
[version_img]: https://img.shields.io/static/v1.svg?label=CalVer&message=v202103.1028&color=blue
